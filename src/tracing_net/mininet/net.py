...
Note: If the network topology is created using mininet-d.topo, then
...
Currently we wrap the entire network in a 'mininet-d' object, which
constructs a simulated network based on a network topology created
using a topology object (e.g. LinearTopo) from mininet-d.topo or
mininet-d.topolib, and a Controller which the switches will connect
...
and bandwidth tests and running the mininet-d CLI.
...
class Mininet( object ):
    ...
    def buildFromTopo( self, topo=None ):
        """Build mininet-d from a topology object
