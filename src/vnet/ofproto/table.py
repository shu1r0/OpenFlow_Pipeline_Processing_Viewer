...
from src.vnet.ofproto.instruction import InstructionResult, Instruction
...
flowtables_id = 0
def get_flowtables_id():
    global flowtables_id
    flowtables_id += 1
    return flowtables_id