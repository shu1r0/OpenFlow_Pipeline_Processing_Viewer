...
from src.vnet.ofproto.match import OxmOfbMatchField2stringfield, mac_address2str, ipv4address2str, \
    ipv6address2str

setLoggerClass(Logger)
logger = getLogger('vnet.action')
...
class ActionSet:
    ...
    def action(self, msg):
        ...
        Returns:
            InstructionResult
        """
        from src.vnet.ofproto.instruction import InstructionResult
