...
class MiniEdit( Frame ):
    ...
    def exportScript( self ):
        ...
        if len(fileName ) > 0:
            ...
            f.write("\n")
            f.write("from mininet-d.net import Mininet\n")
            f.write("from mininet-d.node import Controller, RemoteController, OVSController\n")
            f.write("from mininet-d.node import CPULimitedHost, Host, Node\n")
            f.write("from mininet-d.node import OVSKernelSwitch, UserSwitch\n")
            if StrictVersion(MININET_VERSION) > StrictVersion('2.0'):
                f.write("from mininet-d.node import IVSSwitch\n")
            f.write("from mininet-d.cli import CLI\n")
            f.write("from mininet-d.log import setLogLevel, info\n")
            f.write("from mininet-d.link import TCLink, Intf\n")
    ...
    # mininet-d object here, probably.
